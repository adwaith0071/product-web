...
const AuthLayout: React.FC<AuthLayoutProps> = ({
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 bg-gradient-to-br from-blue-800 via-blue-900 to-slate-900 relative overflow-hidden min-h-[40vh] lg:min-h-screen">
        {/* Decorative shapes */}
        <div className="absolute top-10 md:top-20 right-10 md:right-20 transform rotate-45">
          <div className="w-12 h-12 md:w-16 md:h-16 bg-blue-600 opacity-30 rounded-lg"></div>
        </div>
        <div className="absolute top-20 md:top-40 left-10 md:left-20 transform rotate-45">
          <div className="w-8 h-8 md:w-12 md:h-12 bg-blue-500 opacity-40 rounded-lg"></div>
        </div>
        <div className="absolute bottom-20 md:bottom-40 right-20 md:right-40 transform rotate-45">
          <div className="w-16 h-16 md:w-20 md:h-20 bg-blue-700 opacity-25 rounded-lg"></div>
        </div>
        <div className="absolute bottom-10 md:bottom-20 left-10 md:left-20">
          <div className="w-24 h-24 md:w-32 md:h-32 bg-blue-600 opacity-20 rounded-full"></div>
        </div>
        <div className="absolute top-1/2 right-5 md:right-10 transform -translate-y-1/2 rotate-45">
          <div className="w-6 h-6 md:w-8 md:h-8 bg-blue-400 opacity-50 rounded-lg"></div>
        </div>
